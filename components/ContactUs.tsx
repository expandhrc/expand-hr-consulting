      ...
      >
        <div className="relative rounded-xl py-6 z-20 flex flex-1 flex-col items-center xl:max-w-[90%]">
          <p className="p-regular mt-6 text-paleBlue">
            ...
            embark on a collaborative journey towards transformative solutions.
            ...
            potential for collaboration, our team is ready to assist. Reach out
            through the provided contact information, and let's start a
            conversation that leads to innovative strategies and lasting
            success. Welcome to a consultancy experience where your goals become
            our focus. Contact us today, and let's navigate the path to your
            business excellence together.
          </p>
        </div>
        <div
